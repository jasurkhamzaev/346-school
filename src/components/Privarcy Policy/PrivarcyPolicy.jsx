...
import './PrivarcyPolicy.css'

function PrivarcyPolicy() {
  return (
    <div className='privarcy-policy-page'>
      <header className='height-75'>
        <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
          <h1 className='text-center fw-semibold'>Privarcy Policy</h1>
        </div>
      </header>
